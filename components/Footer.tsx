      ...
      <div className="container section-padding">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <h3 className="text-2xl font-display font-bold mb-4">NERDY'S HIDEOUT</h3>
            <p className="text-secondary mb-4">
              An exclusive, invite-only music experience. 
              <br />
              Coordinates unknown. Energy certain.
            </p>
            <p className="text-sm text-secondary">For Real Ones Only.</p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/mixes" className="text-secondary hover:text-accent transition-colors">
                  Mixes
                </Link>
              </li>
              <li>
        ...
        <div className="mt-12 pt-8 border-t border-border">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <p className="text-sm text-secondary">
              {currentYear} Nerdy's Hideout. All rights reserved.
            </p>
